...
import random
from Django1.wsgi import *
from blog.models import Article, Author ,Tag


author_name_list = ['WeizhongTu','twz915','dachui','goudan']
article_title_list = ['Django教程','Python教程','HTML教程','JS教程']
...
def create_authors():
    for author_name in author_name_list:
        ...
        author.addr = 'addr_%s' % (random.randrange(1,100))
...
def create_articles_and_tags():
    ...
    for article_title in article_title_list:
        ...
        for i in range(1,20):
            ...
            article, create = Article.objects.get_or_create(
